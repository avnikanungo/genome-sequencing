# 📋 Literature Review Dossier Template

This is the standard review dossier template. Every team member must copy this file to their own member file at `literature-review/members/<your-name>.md` and populate it for all 9 papers.

---

# 🧑‍🔬 Research Dossier: [Your Name]
*   **Role**: [Your Team Role]
*   **Repository Component**: [e.g., Problem 3 (Variant Prioritization) or Problem 4 (Genome Assembly)]

---

## 📈 Executive Summary
*Leave this section blank until all 9 reviews are complete. Write a 3-4 sentence overview of the collective insights gained from your assigned and self-selected papers.*
...
### 📄 Paper 5: [Self-Selected Paper 1 Title]
*   **Authors**: _[Fill in]_
*   **Year**: _[Fill in]_
*   **Journal / Conference**: _[Fill in]_
*   **DOI**: _[Fill in]_
...
### 📄 Paper 6: [Self-Selected Paper 2 Title]
*   **Authors**: _[Fill in]_
*   **Year**: _[Fill in]_
*   **Journal / Conference**: _[Fill in]_
*   **DOI**: _[Fill in]_
...
### 📄 Paper 7: [Self-Selected Paper 3 Title]
*   **Authors**: _[Fill in]_
*   **Year**: _[Fill in]_
*   **Journal / Conference**: _[Fill in]_
*   **DOI**: _[Fill in]_
...
### 📄 Paper 8: [Self-Selected Paper 4 Title]
*   **Authors**: _[Fill in]_
*   **Year**: _[Fill in]_
*   **Journal / Conference**: _[Fill in]_
*   **DOI**: _[Fill in]_
...
### 📄 Paper 9: [Self-Selected Paper 5 Title]
*   **Authors**: _[Fill in]_
*   **Year**: _[Fill in]_
*   **Journal / Conference**: _[Fill in]_
*   **DOI**: _[Fill in]_
...
*Leave this section blank until all reviews are complete. Compile these final conclusions to summarize your findings:*

### 🔍 Common Themes Across Reviewed Papers
*   *Theme 1: [e.g., Deep learning architectures are outperforming traditional statistical models in alignment accuracy]*
*   *Theme 2: [your notes here]*

### 🛠️ Key Methods/Tools That Appear Repeatedly
*   *Method/Tool 1: [e.g., Graph Neural Networks for representing assembly overlaps]*
*   *Method/Tool 2: [your notes here]*

### 🕳️ Gaps in Literature Relevant to Our Project
*   *Gap 1: [e.g., High memory footprints of GNN models on eukaryotic whole-genome sizes]*
