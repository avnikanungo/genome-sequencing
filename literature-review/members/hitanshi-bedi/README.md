# 🧑‍🔬 Research Review Dossier: Hitanshi Bedi
*   **Role**: Research Member
*   **Repository Component**: Literature Review (9 Papers)

This directory houses the systematic literature reviews for Hitanshi Bedi. Follow the links below to view or edit the respective paper reviews.
...
5.  **[Paper 5: An Alignment-Based DNA Language Model for Genome-Wide Variant Effect Prediction](paper-5.md)**
    *   *Preprint (2024)* | DOI: `TBC`
6.  **[Paper 6: Contrastive Learning-Based Deep Hybrid Network for Nanopore Methylation Detection](paper-6.md)**
    *   *Preprint (2024)* | DOI: `TBC`
7.  **[Paper 7: A Semi-Supervised Approach to Analyzing Multi-Condition Single-Cell RNA Sequencing Data Using Graph Neural Networks](paper-7.md)**
    *   *Preprint (2024)* | DOI: `TBC`
8.  **[Paper 8: A Hierarchical Genomic Deep Neural Network with 1D Shifted Window Transformer](paper-8.md)**
    *   *Preprint (2023)* | DOI: `TBC`
9.  **[Paper 9: High-Throughput Deep Learning Variant Effect Prediction with Sequence UNET](paper-9.md)**
    *   *Preprint (2023)* | DOI: `TBC`
