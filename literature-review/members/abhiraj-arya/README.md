# 🧑‍🔬 Research Review Dossier: Abhiraj Arya
*   **Role**: Research Member
*   **Repository Component**: Literature Review (9 Papers)

This directory houses the systematic literature reviews for Abhiraj Arya. Follow the links below to view or edit the respective paper reviews.
...
5.  **[Paper 5: Deep Learning for Genomics: From Early Neural Nets to Modern Large Language Models](paper-5.md)**
    *   *International Journal of Molecular Sciences (2023)* | DOI: `10.3390/ijms24032304`
6.  **[Paper 6: Deep Learning-Based Identification of Genetic Variants: Application to Alzheimer's Disease Classification](paper-6.md)**
