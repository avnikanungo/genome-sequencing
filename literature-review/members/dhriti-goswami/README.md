# 🧑‍🔬 Research Review Dossier: Dhriti Goswami
*   **Role**: Research Member
*   **Repository Component**: Literature Review (9 Papers)

This directory houses the systematic literature reviews for Dhriti Goswami. Follow the links below to view or edit the respective paper reviews.
...
5.  **[Paper 5: Artificial Intelligence in Clinical and Genomic Diagnostics](paper-5.md)**
    *   *Genome Medicine (2018)* | DOI: `10.1186/s13073-018-0589-9`
6.  **[Paper 6: Advancing Genome Editing with Artificial Intelligence: Opportunities, Challenges, and Future Directions](paper-6.md)**
    *   *Frontiers in Bioengineering and Biotechnology (2023)* | DOI: `10.3389/fbioe.2023.1256871`
7.  **[Paper 7: Long-Read Human Genome Sequencing and its Applications](paper-7.md)**
    *   *Nature Reviews Genetics (2020)* | DOI: `10.1038/s41576-020-0236-x`
8.  **[Paper 8: Deep Learning for Genomics: A Concise Overview](paper-8.md)**
    *   *arXiv (2018)* | DOI: `10.48550/arXiv.1802.00810`
9.  **[Paper 9: Geometric Deep Learning Framework for de Novo Genome Assembly](paper-9.md)**
    *   *bioRxiv / Genome Research (2021/2025)* | DOI: `10.1101/2024.03.11.584353`
