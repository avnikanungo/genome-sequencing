# 🧑‍🔬 Research Review Dossier: Akshita Goel
*   **Role**: Research Member
*   **Repository Component**: Literature Review (9 Papers)

This directory houses the systematic literature reviews for Akshita Goel. Follow the links below to view or edit the respective paper reviews.
...
5.  **[Paper 5: Artificial Intelligence and Machine Learning Approaches Using Gene Expression and Variant Data for Personalized Medicine](paper-5.md)**
    *   *Briefings in Bioinformatics (2022)* | DOI: `10.1093/bib/bbab524`
6.  **[Paper 6: Translating Cancer Genomics into Precision Medicine with Artificial Intelligence: Applications, Challenges and Future Perspectives](paper-6.md)**
    *   *Cancer Cell International (2021)* | DOI: `10.1186/s12935-021-01826-6`
7.  **[Paper 7: Typing Methods Based on Whole Genome Sequencing Data](paper-7.md)**
    *   *Methods in Molecular Biology (2017)* | DOI: `10.1007/978-1-4939-7337-8_13`
8.  **[Paper 8: Long Walk to Genomics: History and Current Approaches to Genome Sequencing and Assembly](paper-8.md)**
    *   *Computational and Structural Biotechnology Journal (2020)* | DOI: `10.1016/j.csbj.2019.11.002`
9.  **[Paper 9: The Application of Long-Read Sequencing in Clinical Settings](paper-9.md)**
    *   *Frontiers in Genetics (2022)* | DOI: `10.3389/fgene.2022.986348`
