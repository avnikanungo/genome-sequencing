# 🧑‍🔬 Research Review Dossier: Aditya Panda
*   **Role**: Research Member
*   **Repository Component**: Literature Review (9 Papers)

This directory houses the systematic literature reviews for Aditya Panda. Follow the links below to view or edit the respective paper reviews.
...
5.  **[Paper 5: Predicting Splicing from Primary Sequence with Deep Learning](paper-5.md)**
    *   *Cell (2019)* | DOI: `10.1016/j.cell.2018.12.015`
6.  **[Paper 6: Genome-Wide Prediction of Disease Variant Effects with a Deep Protein Language Model (ESM1b)](paper-6.md)**
    *   *Preprint (2022)* | DOI: `TBC`
7.  **[Paper 7: Effective Gene Expression Prediction from Sequence by Integrating Long-Range Interactions (Enformer)](paper-7.md)**
    *   *Nature Methods (2021)* | DOI: `10.1038/s41592-021-01252-x`
8.  **[Paper 8: Haplotype-Aware Variant Calling with PEPPER-Margin-DeepVariant Enables High Accuracy in Nanopore Long-Reads](paper-8.md)**
    *   *Nature Methods (2021)* | DOI: `10.1038/s41592-021-01299-w`
9.  **[Paper 9: DeepConsensus Improves the Accuracy of Sequences with a Gap-Aware Sequence Transformer](paper-9.md)**
    *   *Nature Biotechnology (2023)* | DOI: `10.1038/s41587-022-01435-7`
