# 🧑‍🔬 Research Review Dossier: Lavanya Mathur
*   **Role**: Research Member
*   **Repository Component**: Literature Review (9 Papers)

This directory houses the systematic literature reviews for Lavanya Mathur. Follow the links below to view or edit the respective paper reviews.
...
5.  **[Paper 5: DeepC: Predicting 3D Genome Folding Using Megabase-Scale Transfer Learning](paper-5.md)**
    *   *Nature Methods (2020)* | DOI: `10.1038/s41592-020-0854-y`
6.  **[Paper 6: Predicting 3D Genome Folding from DNA Sequence with Akita](paper-6.md)**
    *   *Nature Methods (2020)* | DOI: `10.1038/s41592-020-0958-4`
7.  **[Paper 7: DeepSignal: Detecting DNA Methylation State from Nanopore Sequencing Reads Using Deep-Learning](paper-7.md)**
    *   *Bioinformatics (2019)* | DOI: `10.1093/bioinformatics/btz276`
8.  **[Paper 8: A Multi-Task Convolutional Deep Neural Network for Variant Calling in Single Molecule Sequencing](paper-8.md)**
    *   *Nature Communications (2019)* | DOI: `10.1038/s41467-019-09025-z`
9.  **[Paper 9: Chiron: Translating Nanopore Raw Signal Directly into Nucleotide Sequence Using Deep Learning](paper-9.md)**
